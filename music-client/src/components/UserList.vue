    ...
    <el-table :data="userList" highlight-current-row>
      <el-table-column prop="avator" label="头像" width="100">
        <template #default="scope">
          <el-image :src="attachImageUrl(scope.row.avator)" style="width: 50px; height: 50px; border-radius: 50%;" @click.stop="goToUserHome(scope.row.followedId)" />
        </template>
      </el-table-column>
      ...
      <el-table-column v-if="isLoggedIn" label="操作" width="150">
        <template #default="scope">
